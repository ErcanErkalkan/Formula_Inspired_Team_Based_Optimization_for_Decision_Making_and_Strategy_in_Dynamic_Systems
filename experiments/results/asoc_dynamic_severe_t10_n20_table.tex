\begin{table}[H]
\centering
\caption{Auxiliary generation-matched protocol results for the severe taut=10, nt=20 dynamic protocol. These diagnostic values are not the primary fixed-budget values discussed in the main text.}
